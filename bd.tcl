...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {ddr3_ck} \
   CONFIG.CLK_OUT2_PORT {p90_ck} \
   CONFIG.CLK_OUT3_PORT {ui_ck} \
   CONFIG.CLK_OUT4_PORT {ref_ck} \
  ...
  # Create instance: ddr3_top_axi_0, and set properties
  set block_name ddr3_top_axi
  set block_cell_name ddr3_top_axi_0
  if { [catch {set ddr3_top_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ddr3_top_axi_0 eq "" } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net SYS_CLK_0_1 [get_bd_intf_ports sys] [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins ddr3_top_axi_0/s_axi]
  ...
  connect_bd_intf_net -intf_net ddr3_top_axi_0_ddr3 [get_bd_intf_ports ddr3] [get_bd_intf_pins ddr3_top_axi_0/ddr3]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_IP [get_bd_intf_pins axi_smc/S03_AXI] [get_bd_intf_pins microblaze_0/M_AXI_IP]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]

  # Create port connections
  connect_bd_net -net clk_wiz_1_ddr3_ck [get_bd_pins clk_wiz_1/ddr3_ck] [get_bd_pins ddr3_top_axi_0/i_ddr3_clk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins ddr3_top_axi_0/i_rst_n] [get_bd_pins rst_mig_7series_0_100M/dcm_locked]
  connect_bd_net -net clk_wiz_1_p90_ck [get_bd_pins clk_wiz_1/p90_ck] [get_bd_pins ddr3_top_axi_0/i_ddr3_clk_90]
  connect_bd_net -net clk_wiz_1_ref_ck [get_bd_pins clk_wiz_1/ref_ck] [get_bd_pins ddr3_top_axi_0/i_ref_clk]
  connect_bd_net -net clk_wiz_1_ui_ck [get_bd_pins axi_smc/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/ui_ck] [get_bd_pins ddr3_top_axi_0/i_controller_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_2_dout [get_bd_ports a1] [get_bd_ports a2] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins rst_mig_7series_0_100M/ext_reset_in] [get_bd_pins xlconstant_4/dout]
  ...
  assign_bd_address -offset 0x20000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ddr3_top_axi_0/s_axi/reg0] -force
  assign_bd_address -offset 0x20000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs ddr3_top_axi_0/s_axi/reg0] -force
